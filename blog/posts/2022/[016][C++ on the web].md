...
Starting with https://almostalwaysauto.com/posts/basic-gui
...
The SDL2 library needs to be initiallized just like before.
...
Before checking for our keyboard events, first check for shutdown commands.
...
Run make build once again the refresh the browser to see the application run as it did in the previous post.
