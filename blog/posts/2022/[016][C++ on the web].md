...
This is the default web page generated by Emscripten.  The console output from our program is written to a text area in the bottom section.  The top section is a canvas element where any graphics are displayed.
