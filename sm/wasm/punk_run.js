...
function findWasmBinary() {
  return locateFile('punk_run.wasm');
}
...
function assignWasmExports(wasmExports) {
  ...
  assert(typeof wasmExports['gamepad_button'] != 'undefined', 'missing Wasm export: gamepad_button');
  assert(typeof wasmExports['get_state'] != 'undefined', 'missing Wasm export: get_state');
  ...
  _gamepad_button = Module['_gamepad_button'] = createExportWrapper('gamepad_button', 2);
  _get_state = Module['_get_state'] = createExportWrapper('get_state', 0);
